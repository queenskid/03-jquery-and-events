...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      $('#articles div').siblings().hide();
      $('#articles').find('article').attr('data-author', $(this).val()).show();
      console.log($('#articles').find('article').attr('data-author'));
      ...
      $('#articles div').siblings().hide();
      $('#articles div').siblings().not('.template').fadeIn();
    }
    $('#category-filter').val('');
  });
};
